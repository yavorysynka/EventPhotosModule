...
abstract class AbstractAlbumFormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents()
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'rkeventphotosmodule.form_aware_hook.albums.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'rkeventphotosmodule.form_aware_hook.albums.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'rkeventphotosmodule.form_aware_hook.albums.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'rkeventphotosmodule.form_aware_hook.albums.process_delete'
        ];
    }
}
