...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from event photos app';
     *     $event->getRequest()->attributes->set('RKEventPhotosModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('RKEventPhotosModule_test');`
     *     now `$testMessage` should be: `'Hello from event photos app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('event photos App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
