...
namespace RK\EventPhotosModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKEventPhotosModule:js/RKEventPhotosModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKEventPhotosModule:js/RKEventPhotosModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('RKEventPhotosModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        $view = Zikula_View::getInstance('RKEventPhotosModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKEventPhotosModule_objecttype', 'album');
