...
namespace RK\EventPhotosModule\Form\Type\Finder\Base;
...
abstract class AbstractAlbumItemFinderType extends AbstractType
{
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\EventPhotosModule\Entity\\' . ucfirst($options['object_type']) . 'CategoryEntity',
    ...
    {
        return 'rkeventphotosmodule_albumitemfinder';
    }
