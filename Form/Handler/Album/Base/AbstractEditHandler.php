...
namespace RK\EventPhotosModule\Form\Handler\Album\Base;

use RK\EventPhotosModule\Form\Handler\Common\EditHandler;
use RK\EventPhotosModule\Form\Type\AlbumType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKEventPhotosModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'album', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
