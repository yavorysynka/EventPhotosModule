...
namespace RK\EventPhotosModule\Twig\Base;
...
use RK\EventPhotosModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkeventphotosmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkeventphotosmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkeventphotosmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkeventphotosmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkeventphotosmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('rkeventphotosmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkeventphotosmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkeventphotosmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkeventphotosmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkeventphotosmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkeventphotosmodule_fileSize }}
     *
    ...
    /**
     * The rkeventphotosmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkeventphotosmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkeventphotosmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkeventphotosmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rkeventphotosmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|rkeventphotosmodule_formattedTitle }}
     *
