...
function rKEventPhotosToday(format) {
...
function rKEventPhotosReadDate(val, includeTime) {
...
function rKEventPhotosValidateNoSpace(val) {
    var valStr;
...
function rKEventPhotosValidateUploadExtension(val, elem) {
 ...
 */
function rKEventPhotosExecuteCustomValidationConstraints(objectType, currentEntityId) {
    jQuery('.validate-upload').each(function () {
        if (!rKEventPhotosValidateUploadExtension(jQuery(this).val(), jQuery(this))) {
