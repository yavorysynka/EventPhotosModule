...
namespace RK\EventPhotosModule\HookProvider\Base;
...
abstract class AbstractAlbumUiHooksProvider implements HookProviderInterface
{
    ...
    {
        return 'provider.rkeventphotosmodule.ui_hooks.albums';
    }
    ...
    {
        return 'RK\EventPhotosModule\Entity\HookAssignmentEntity';
    }
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@RKEventPhotosModule/Album/includeDisplayItemListMany.html.twig';
