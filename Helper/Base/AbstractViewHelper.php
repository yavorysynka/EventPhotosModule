...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func, $isAdmin = false)
    {
        ...
        $template = '@RKEventPhotosModule/' . ucfirst($type) . '/' . ($isAdmin ? 'Admin/' : '') . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('RKEventPhotosModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = [];
            } else {
