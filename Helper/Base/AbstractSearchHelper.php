...
abstract class AbstractSearchHelper implements SearchableInterface
{
    ...
    {
        if (!$this->permissionApi->hasPermission('RKEventPhotosModule::', '::', ACCESS_READ)) {
            return '';
        }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        foreach ($searchTypes as $searchTypeCode => $typeInfo) {
            ...
            if (isset($moduleActivationInfo['RKEventPhotosModule'])) {
                $moduleActivationInfo = $moduleActivationInfo['RKEventPhotosModule'];
            ...
            foreach ($entities as $entity) {
                ...
                if (!$this->permissionApi->hasPermission('RKEventPhotosModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', ACCESS_OVERVIEW)) {
                    continue;
                }
                ...
                if ($hasDisplayAction) {
                    ...
                    $displayUrl = new RouteUrl('rkeventphotosmodule_' . strtolower($objectType) . '_display', $urlArgs);
                }
    
                $result = new SearchResultEntity();
                $result->setTitle($formattedTitle)
                    ->setText($description)
                    ->setModule('RKEventPhotosModule')
                    ->setCreated($created)
    ...
    {
        $searchTypes = [
            'rKEventPhotosModuleAlbums' => [
                'value' => 'album',
                'label' => $this->__('Albums')
            ],
            'rKEventPhotosModuleAlbumItems' => [
                'value' => 'albumItem',
